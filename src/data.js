// src/data.js - 2026/01/20 最終嚴格修正版 (果醬+20/補貝果/抓餅價格修正)
...
export const initialMenuData = [
  ...
  // --- 7. 中式系列 (抓餅價格修正：依照圖1第2排價格) ---
  { category: '中式系列', name: '原味酥皮蛋餅', price: 35 },
  { category: '中式系列', name: '火腿蛋餅', price: 45 },
  { category: '中式系列', name: '玉米蛋餅', price: 45 },
  { category: '中式系列', name: '薯餅蛋餅', price: 50 },
  { category: '中式系列', name: '培根蛋餅', price: 50 },
  ...
  { category: '中式系列', name: '火腿/玉米抓餅', price: 45 },
  { category: '中式系列', name: '薯餅/培根抓餅', price: 50 },
  { category: '中式系列', name: '鮪魚抓餅', price: 55 }, // 圖表顯示鮪魚抓餅與蛋餅同價 $55
  { category: '中式系列', name: '牽絲蛋起司抓餅', price: 60 }, // 蛋餅$50, 抓餅$60
  { category: '中式系列', name: '起司菇菇蛋抓餅', price: 60 }, // 蛋餅$50, 抓餅$60
  { category: '中式系列', name: '健身愛雞胸抓餅', price: 70 }, // 蛋餅$60, 抓餅$70
  { category: '中式系列', name: '厚遇里肌抓餅', price: 75 }, // 蛋餅$65, 抓餅$75
  { category: '中式系列', name: '德味狂想抓餅', price: 80 }, // 蛋餅$70, 抓餅$80
  { category: '中式系列', name: '北海金鱈抓餅', price: 85 }, // 蛋餅$75, 抓餅$85
  { category: '中式系列', name: '極上豚勝抓餅', price: 90 }, // 蛋餅$80, 抓餅$90
  { category: '中式系列', name: '原味卡拉雞腿抓餅', price: 90 }, // 蛋餅$80, 抓餅$90
  { category: '中式系列', name: '辣味卡拉雞腿抓餅', price: 90 }, // 蛋餅$80, 抓餅$90
  { category: '中式系列', name: '雙魚物語抓餅', price: 95 }, // 蛋餅$85, 抓餅$95
  { category: '中式系列', name: '朝日炙香嫩腿抓餅', price: 95 }, // 蛋餅$85, 抓餅$95
  { category: '中式系列', name: '挽肉愛吃豬抓餅', price: 95 }, // 蛋餅$85, 抓餅$95
  { category: '中式系列', name: '挽肉愛吃牛抓餅', price: 100 }, // 蛋餅$90, 抓餅$100
  // 蘿蔔糕
  ...
  // --- 10. 果醬系列 (完全修正：吐司基準價，厚片/貝果 皆+20元) ---
  // 巧克力
  { category: '果醬系列', name: '巧克力吐司', price: 30 }, 
  { category: '果醬系列', name: '巧克力厚片', price: 50 }, 
  { category: '果醬系列', name: '巧克力貝果', price: 50 },
  // 草莓
  { category: '果醬系列', name: '草莓吐司', price: 30 }, 
  { category: '果醬系列', name: '草莓厚片', price: 50 }, 
  { category: '果醬系列', name: '草莓貝果', price: 50 },
  // 奶油
  { category: '果醬系列', name: '奶油吐司', price: 30 }, 
  { category: '果醬系列', name: '奶油厚片', price: 50 }, 
  { category: '果醬系列', name: '奶油貝果', price: 50 },
  // 花生
  { category: '果醬系列', name: '花生吐司', price: 30 }, 
  { category: '果醬系列', name: '花生厚片', price: 50 }, 
  { category: '果醬系列', name: '花生貝果', price: 50 },
  // 法式焦糖奶油
  { category: '果醬系列', name: '法式焦糖奶油吐司', price: 30 }, 
  { category: '果醬系列', name: '法式焦糖奶油厚片', price: 50 }, 
  { category: '果醬系列', name: '法式焦糖奶油貝果', price: 50 },
  // 流沙奶酥
  { category: '果醬系列', name: '流沙奶酥吐司', price: 30 }, 
  { category: '果醬系列', name: '流沙奶酥厚片', price: 50 }, 
  { category: '果醬系列', name: '流沙奶酥貝果', price: 50 },
  // 自製原味奶酥 (吐司$40，所以厚片/貝果$60)
  { category: '果醬系列', name: '自製原味奶酥吐司', price: 40 }, 
  { category: '果醬系列', name: '自製原味奶酥厚片', price: 60 }, 
  { category: '果醬系列', name: '自製原味奶酥貝果', price: 60 },
  // 自製咖啡奶酥 (吐司$40，所以厚片/貝果$60)
  { category: '果醬系列', name: '自製咖啡奶酥吐司', price: 40 }, 
  { category: '果醬系列', name: '自製咖啡奶酥厚片', price: 60 }, 
  { category: '果醬系列', name: '自製咖啡奶酥貝果', price: 60 },
